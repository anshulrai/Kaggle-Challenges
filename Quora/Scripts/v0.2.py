...
if __name__ == "__main__":
    ...
    for EMBEDDING_FILE in embedding_list:
        ...
        print('>>\t TRAINING FOR FIXED {}!'.format(embedding_name))
        ...
        print('>>\t TRAINING EMBEDDINGS FOR FIXED {} \t DONE!'.format(embedding_name))
        ...
        print('>>\t TRAINING EMBEDDINGS FOR TRAINABLE {}!'.format(embedding_name))
        model.fit([X_train, train_features], train_labels, batch_size=batch_size, epochs=epochs, shuffle = True)
        print('>>\t TRAINING EMBEDDINGS FOR TRAINABLE {} \t DONE!'.format(embedding_name))
        
        # PREDICT AND SAVE PREDICTIONS
        print('>>\t PREDICTING FOR {}!'.format(embedding_name))
        final_preds += 0.333*model.predict([X_test,test_features], batch_size=batch_size)
        print('>>\t PREDICTING FOR {} \t DONE!'.format(embedding_name))
