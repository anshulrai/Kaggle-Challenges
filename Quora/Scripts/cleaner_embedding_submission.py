...
### TO DO: 
# Don't ignore embedding < embed_size
# Experiment with giving FastText priority in embedding

change_string = '"cleaner_embedding_submission.py" : Added cleaning for unknown words.\n'
