...
#GLOBAL VARIABLES
path = '../input/'
split = 1400000 # use -1 for submission, otherwise tha value of split is the number of instances in train
cores = 4
max_text_length=60###################
min_df_one=5
min_df_bi=5
...
submission_idx = []
chunk_counter=1
for df_submission in pd.read_csv(path+'test.tsv', sep='\t', encoding='utf-8' , chunksize=1000000):
