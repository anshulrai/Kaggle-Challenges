...
def shuffle_features(df, target):
    _seed = seed
    _df = pd.DataFrame()
...
def main():
    ...
    train_df = pd.concat([shuffle_features(train_df_1, 1), shuffle_features(train_df_0, 0)], axis=0)
...
if __name__ == "__main__":
    change_log = "Verifying auc score after shuffling feature values."
